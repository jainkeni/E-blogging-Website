        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="POST" enctype="multipart/form-data">
            <div class="row mx-2">
                    ...
                    <div class="card mb-4">
                            ...
                            <div class="col-12">
                                <div class="block-style-10">
                                    <div class="block-title-1">
                                        <h3 class="card-title-1">Title<sup style="color:red">*</sup></h3>
                                    </div>
                        ...
                        <div class="row m-3">
                            <div class="col-12">
                                <div class="block-style-10">
                                    <div class="block-title-1">
                                        <h3 class="card-title-1">Blog Description<sup style="color:red">*</sup></h3>
                                    </div>
                                    <div class="small-list-posts">
                                        <!-- Item -->
                ...
                <div class="col-3">
                    <div class="block-style-10">
    					<div class="block-title-1">
                            <h3 class="card-title">Upload Title Image <sup style="color:red">*</sup> </h3>
                    ...
                    <div class="block-style-10">
    					<div class="block-title-1">
                            <h3 class="card-title-1">Category<sup style="color:red">*</sup></h3>
							<img src="assets/images/svg/more-1.svg" alt="Zola">
						</div>
    					<div class="small-list-posts">
							<!-- Item -->
                    ...
                    <div class="block-style-10">
    					<div class="block-title-1">
                            <h3 class="card-title-1">Save As Draft</h3>
							<img src="assets/images/svg/more-1.svg" alt="Zola">
						</div>
    					<div class="small-list-posts">
							<!-- Item -->
                    ...
                    <div class="block-style-10">
    					<div class="block-title-1">
                            <h3 class="card-title-1">Publish</h3>
							<img src="assets/images/svg/more-1.svg" alt="Zola">
						</div>
    					<div class="small-list-posts">
							<!-- Item -->
