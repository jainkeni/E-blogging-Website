...
<body class="bg-grey2">
	...
	<div id="section-slider" class="slider05 v3">
		...
		<div class="slider-image">
			<img class="img-fluid" src="assets/images/slider7.jpg" alt="Zola">
		</div>
		<!-- /.Slider Image -->
    </div>
    <!-- /.Section Slider 05 -->
    				...
    				<div class="block-style-29">
    					<div class="login-wrapper">
							...
							<div class="contact-form">
								<!-- Form -->
								<form action="./admin/registerValidate.php" method="POST">
									<div class="row">
									...
									<div class="row">
										<div class="form-group col-md-12">
											...
											<p class="tnc">By creating an account, you agree to our <br> <a href="#">Terms of Service</a> and our <a href="#">Privacy Policy.</a></p>
										</div>
									</div>
								</form>
								<!-- /.Form -->
