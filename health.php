...
<body>
	...
	<div id="section-slider" class="slider01">
		...
		<div class="slider-image">
			<img class="img-fluid" src="https://source.unsplash.com/1600x500/?yoga,gym" alt="Zola">
		</div>
		<!-- /.Slider Image -->
    </div>
    <!-- /.Section Slider 02 -->
    	...
    	<div class="container">
    		<div class="row">
    			<div class="col-12 col-lg-8">
					...
					<?php
						include("config.php");
						$sql = "SELECT Post_ID,title,description,author,featured, category from posts where status='publish' and category='health' order by date desc;";
						$result = $db->query($sql);
