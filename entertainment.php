...
<body>
	...
	<div id="section-slider" class="slider01">
		...
		<div class="slider-image">
			<img class="img-fluid" src="https://source.unsplash.com/1600x500/?movies,actor" alt="Zola">
		</div>
		<!-- /.Slider Image -->
    </div>
    <!-- /.Section Slider 02 -->
    	...
    	<div class="container">
    		<div class="row">
    			<div class="col-12 col-lg-8">
					...
					<?php
						include("config.php");
						$sql = "SELECT Post_ID,title,description,author,featured, category from posts where status='publish' and category='entertainment' order by date desc;";
						$result = $db->query($sql);
								...
								<div class='block-style-12'>
									...
									<div class='contents'>
										...
										<div class='content-wrapper'>
											...
											<!-- Description -->
											<div class='desc'>
												<p>".substr($row['description'], 0, strrpos($row['description'], ' ', 100-strlen($row['description']))) ."...</p>
											</div>
											<!-- /.Description -->
										</div>
										<!-- Content Wrapper -->
